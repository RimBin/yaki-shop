              ...
              return (
                ...
                >
                  <div className={`relative w-full overflow-hidden rounded-[12px] ${idx % 2 === 0 ? 'h-[520px]' : 'h-[330px]'}`}>
                    <SeoImage
                      src={project.image}
                      alt={buildProjectImageSeo(currentLocale, { title: project.title, location: project.location }).alt}
                      title={buildProjectImageSeo(currentLocale, { title: project.title, location: project.location }).title}
                      description={buildProjectImageSeo(currentLocale, { title: project.title, location: project.location }).description}
                      fill
