      ...
      <div className="relative md:pt-5 lg:pt-[56px]">
        ...
        <div className="max-w-[1440px] mx-auto px-[16px] md:px-[32px] lg:px-[40px] relative z-10">
          <div className="relative h-[200px] md:h-[450px] lg:h-[642px] w-full rounded-[8px] overflow-hidden hero-seq-item hero-seq-right" style={{ animationDelay: '0ms' }}>
            <SeoImage
              src={imgVideo}
              alt={buildUiImageSeo('lt', { name: t('videoAlt'), context: 'Apie mus video' }).alt}
              title={buildUiImageSeo('lt', { name: t('videoAlt'), context: 'Apie mus video' }).title}
              description={buildUiImageSeo('lt', { name: t('videoAlt'), context: 'Apie mus video' }).description}
              fill
              sizes="100vw"
              ...
              <div className="hidden lg:flex gap-[16px]">
                ...
                <div className="flex flex-col gap-[8px] w-[328px]">
                  <div className="relative h-[434px] w-full overflow-hidden">
                    <SeoImage
                      src={imgTeam1}
                      alt={buildUiImageSeo('lt', { name: t('teamMemberAlt'), context: 'Komandos nario nuotrauka' }).alt}
                      title={buildUiImageSeo('lt', { name: t('teamMemberAlt'), context: 'Komandos nario nuotrauka' }).title}
                      description={buildUiImageSeo('lt', { name: t('teamMemberRole'), context: 'Komandos nario portretas' }).description}
                      fill
                      sizes="328px"
                      className="object-cover"
                    />
              ...
              <div className="lg:hidden grid grid-cols-2 gap-[16px]">
                <div className="flex flex-col gap-[8px]">
                  <div className="relative h-[218px] w-full overflow-hidden">
                    <SeoImage src={imgTeam1} alt={buildUiImageSeo('lt', { name: t('teamMemberAlt'), context: 'Komandos nario nuotrauka' }).alt} title={buildUiImageSeo('lt', { name: t('teamMemberAlt'), context: 'Komandos nario nuotrauka' }).title} description={buildUiImageSeo('lt', { name: t('teamMemberRole'), context: 'Komandos nario portretas' }).description} fill sizes="(min-width: 1024px) 328px, 50vw" className="object-cover" />
                  </div>
                ...
                <div className="flex flex-col gap-[8px]">
                  <div className="relative h-[218px] w-full overflow-hidden">
                    <SeoImage src={imgTeam2} alt={buildUiImageSeo('lt', { name: t('teamMemberAlt'), context: 'Komandos nario nuotrauka' }).alt} title={buildUiImageSeo('lt', { name: t('teamMemberAlt'), context: 'Komandos nario nuotrauka' }).title} description={buildUiImageSeo('lt', { name: t('teamMemberRole'), context: 'Komandos nario portretas' }).description} fill sizes="(min-width: 1024px) 328px, 50vw" className="object-cover" />
                  </div>
                  <p className="font-['DM_Sans'] font-medium text-[16px] leading-[1.2] tracking-[-0.32px] text-[#161616]">{t('teamMemberName')}</p>
                  <p className="font-['Outfit'] font-light text-[14px] leading-[1.2] tracking-[0.14px] text-[#161616]">{t('teamMemberRole')}</p>
                </div>
                <div className="flex flex-col gap-[8px]">
                  <div className="relative h-[218px] w-full overflow-hidden">
                    <SeoImage src={imgTeam3} alt={buildUiImageSeo('lt', { name: t('teamMemberAlt'), context: 'Komandos nario nuotrauka' }).alt} title={buildUiImageSeo('lt', { name: t('teamMemberAlt'), context: 'Komandos nario nuotrauka' }).title} description={buildUiImageSeo('lt', { name: t('teamMemberRole'), context: 'Komandos nario portretas' }).description} fill sizes="(min-width: 1024px) 328px, 50vw" className="object-cover" />
                  </div>
                  <p className="font-['DM_Sans'] font-medium text-[16px] leading-[1.2] tracking-[-0.32px] text-[#161616]">{t('teamMemberName')}</p>
                  <p className="font-['Outfit'] font-light text-[14px] leading-[1.2] tracking-[0.14px] text-[#161616]">{t('teamMemberRole')}</p>
                </div>
                <div className="flex flex-col gap-[8px]">
                  <div className="relative h-[218px] w-full overflow-hidden">
                    <SeoImage src={imgTeam4} alt={buildUiImageSeo('lt', { name: t('teamMemberAlt'), context: 'Komandos nario nuotrauka' }).alt} title={buildUiImageSeo('lt', { name: t('teamMemberAlt'), context: 'Komandos nario nuotrauka' }).title} description={buildUiImageSeo('lt', { name: t('teamMemberRole'), context: 'Komandos nario portretas' }).description} fill sizes="(min-width: 1024px) 328px, 50vw" className="object-cover" />
                  </div>
                  <p className="font-['DM_Sans'] font-medium text-[16px] leading-[1.2] tracking-[-0.32px] text-[#161616]">{t('teamMemberName')}</p>
                  <p className="font-['Outfit'] font-light text-[14px] leading-[1.2] tracking-[0.14px] text-[#161616]">{t('teamMemberRole')}</p>
                </div>
