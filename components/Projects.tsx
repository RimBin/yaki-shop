...
import { buildProjectImageSeo } from '@/lib/seo/images';
...
export default async function Projects() {
  ...
  const getSeo = (project: Partial<Project> | null | undefined, fallbackTitle: string, fallbackLocation: string) =>
    buildProjectImageSeo(currentLocale, {
      title: getProjectTitle(project as Project, currentLocale) || fallbackTitle,
      location: getProjectLocation(project as Project, currentLocale) || fallbackLocation,
    });
          ...
          >
            <div className="h-[268px] w-full max-w-[267px] rounded-[8px] relative overflow-hidden">
              <SeoImage
                ...
                alt={getSeo(featuredProjects[0], t('fallback.project'), t('fallback.location')).alt}
                title={getSeo(featuredProjects[0], t('fallback.project'), t('fallback.location')).title}
                description={getSeo(featuredProjects[0], t('fallback.project'), t('fallback.location')).description}
                fill
                sizes="267px"
            ...
            >
              <div className="h-[176px] w-full max-w-[230px] rounded-[8px] relative overflow-hidden">
                <SeoImage
                  ...
                  alt={getSeo(featuredProjects[1], t('fallback.project'), t('fallback.location')).alt}
                  title={getSeo(featuredProjects[1], t('fallback.project'), t('fallback.location')).title}
                  description={getSeo(featuredProjects[1], t('fallback.project'), t('fallback.location')).description}
                  fill
                  sizes="230px"
                  className="object-cover"
                />
          ...
          >
            <div className="h-[330px] w-full max-w-[328px] rounded-[8px] relative overflow-hidden">
              <SeoImage
                ...
                alt={getSeo(featuredProjects[2], t('fallback.project'), t('fallback.location')).alt}
                title={getSeo(featuredProjects[2], t('fallback.project'), t('fallback.location')).title}
                description={getSeo(featuredProjects[2], t('fallback.project'), t('fallback.location')).description}
                fill
                sizes="328px"
                className="object-cover"
              />
            ...
            >
              <div className="h-[177px] w-full max-w-[175px] rounded-[8px] relative overflow-hidden">
                <SeoImage
                  ...
                  alt={getSeo(featuredProjects[3], t('fallback.project'), t('fallback.location')).alt}
                  title={getSeo(featuredProjects[3], t('fallback.project'), t('fallback.location')).title}
                  description={getSeo(featuredProjects[3], t('fallback.project'), t('fallback.location')).description}
                  fill
                  sizes="175px"
                  className="object-cover"
                />
            ...
            >
              <div className="h-[176px] w-full max-w-[230px] rounded-[8px] relative overflow-hidden">
                <SeoImage
                  ...
                  alt={getSeo(featuredProjects[4], t('fallback.project'), t('fallback.location')).alt}
                  title={getSeo(featuredProjects[4], t('fallback.project'), t('fallback.location')).title}
                  description={getSeo(featuredProjects[4], t('fallback.project'), t('fallback.location')).description}
                  fill
                  sizes="230px"
                  className="object-cover"
                />
          ...
          >
            <div className="h-[330px] w-full max-w-[328px] rounded-[8px] relative overflow-hidden">
              <SeoImage
                ...
                alt={getSeo(featuredProjects[5], t('fallback.project'), t('fallback.location')).alt}
                title={getSeo(featuredProjects[5], t('fallback.project'), t('fallback.location')).title}
                description={getSeo(featuredProjects[5], t('fallback.project'), t('fallback.location')).description}
                fill
                sizes="328px"
                className="object-cover"
              />
            ...
            >
              ...
              >
                <SeoImage
                  ...
                  alt={getSeo(project, t('fallback.project'), t('fallback.location')).alt}
                  title={getSeo(project, t('fallback.project'), t('fallback.location')).title}
                  description={getSeo(project, t('fallback.project'), t('fallback.location')).description}
                  fill
