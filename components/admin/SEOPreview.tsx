      ...
      <div className="max-w-[500px] border border-[#E1E1E1] rounded-[24px] overflow-hidden bg-[#EAEAEA] shadow-sm">
        ...
        {ogImage ? (
          <div className="w-full aspect-[1.91/1] bg-[#E1E1E1] relative">
            <img src={ogImage} alt={`${ogTitle} Open Graph preview image`} title={`${ogTitle} Open Graph preview image`} className="w-full h-full object-cover" />
          </div>
        ) : (
      ...
      <div className="max-w-[500px] border border-[#E1E1E1] rounded-[24px] overflow-hidden bg-[#EAEAEA] shadow-sm">
        ...
        {twitterImage ? (
          <div className="w-full aspect-[2/1] bg-[#E1E1E1] relative">
            <img src={twitterImage} alt={`${twitterTitle} Twitter preview image`} title={`${twitterTitle} Twitter preview image`} className="w-full h-full object-cover" />
          </div>
        ) : (
