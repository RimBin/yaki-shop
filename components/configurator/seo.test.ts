...
describe('configurator seo helpers', () => {
  test('canonical product path uses /products', () => {
    expect(getCanonicalProductPath('shou-sugi-ban-wood', 'en')).toBe('https://shop.yakiwood.co.uk/products/shou-sugi-ban-wood');
    expect(getCanonicalProductPath('shou-sugi-ban-wood', 'lt')).toBe('https://shop.yakiwood.co.uk/lt/produktai/shou-sugi-ban-wood');
  });
