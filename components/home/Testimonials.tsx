...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="w-full bg-[#E1E1E1]">
      {/* ===== MOBILE/TABLET LAYOUT (< 1536px) - Figma 759:7576 ===== */}
      <InView className="2xl:hidden pt-[64px] md:pt-[80px] pb-0 hero-animate-root">
                ...
                <div className="absolute inset-0">
                  <SeoImage
                    ...
                    alt={buildUiImageSeo(currentLocale, {
                      ...
                      context: currentLocale === 'lt' ? 'Kliento atsiliepimo fonas' : 'Client testimonial background',
                    }).alt}
      ...
      <InView className="hidden 2xl:block max-w-[1848px] mx-auto px-[40px] py-[120px] hero-animate-root">
        <div className="mx-auto flex w-full max-w-[1768px] flex-col gap-[48px]">
