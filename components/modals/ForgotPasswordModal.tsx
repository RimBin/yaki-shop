...
export default function ForgotPasswordModal({ 
  ...
  const logoSeo = buildUiImageSeo(currentLocale, {
    name: 'Yakiwood',
    context: currentLocale === 'lt' ? 'Slaptažodžio atkūrimo lango logotipas' : 'Password recovery modal logo',
    description: currentLocale === 'lt' ? 'Yakiwood slaptažodžio atkūrimo logotipas' : 'Yakiwood password recovery logo',
  });
