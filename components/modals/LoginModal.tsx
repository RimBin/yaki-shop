...
export default function LoginModal({ 
  ...
  const logoSeo = buildUiImageSeo(currentLocale, {
    name: 'Yakiwood',
    context: currentLocale === 'lt' ? 'Prisijungimo lango logotipas' : 'Login modal logo',
    description: currentLocale === 'lt' ? 'Yakiwood paskyros prisijungimo logotipas' : 'Yakiwood account login logo',
  });
