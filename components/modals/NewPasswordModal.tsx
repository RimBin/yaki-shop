...
export default function NewPasswordModal({ 
  ...
  const logoSeo = buildUiImageSeo(currentLocale, {
    name: 'Yakiwood',
    context: currentLocale === 'lt' ? 'Naujo slaptažodžio lango logotipas' : 'New password modal logo',
    description: currentLocale === 'lt' ? 'Yakiwood naujo slaptažodžio nustatymo logotipas' : 'Yakiwood new password setup logo',
  });
