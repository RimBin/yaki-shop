...
export default function RegisterModal({ 
  ...
  const logoSeo = buildUiImageSeo(currentLocale, {
    name: 'Yakiwood',
    context: currentLocale === 'lt' ? 'Registracijos lango logotipas' : 'Registration modal logo',
    description: currentLocale === 'lt' ? 'Yakiwood paskyros registracijos logotipas' : 'Yakiwood account registration logo',
  });
  ...
  const handleGoogleSignUp = async () => {
    ...
    callbackUrl.searchParams.set('next', nextPath || toLocalePath('/account', currentLocale));
