          ...
          <div className="hidden lg:flex gap-4 items-center justify-center w-full max-w-[1440px] mx-auto">
            ...
            <div className="relative h-[543px] w-[350px] rounded-lg overflow-hidden opacity-30">
              <SeoImage
                ...
                alt={buildProjectImageSeo(currentLocale, { title, index: prevIndex }).alt}
                title={buildProjectImageSeo(currentLocale, { title, index: prevIndex }).title}
                description={buildProjectImageSeo(currentLocale, { title, index: prevIndex }).description}
                fill
            ...
            <div className="relative h-[543px] w-[673px] rounded-lg overflow-hidden">
              <SeoImage
                ...
                alt={buildProjectImageSeo(currentLocale, { title, index: currentIndex }).alt}
                title={buildProjectImageSeo(currentLocale, { title, index: currentIndex }).title}
                description={buildProjectImageSeo(currentLocale, { title, index: currentIndex }).description}
                fill
                className="object-cover"
                sizes="673px"
                priority
            ...
            <div className="relative h-[543px] w-[350px] rounded-lg overflow-hidden opacity-30">
              <SeoImage
                ...
                alt={buildProjectImageSeo(currentLocale, { title, index: nextIndex }).alt}
                title={buildProjectImageSeo(currentLocale, { title, index: nextIndex }).title}
                description={buildProjectImageSeo(currentLocale, { title, index: nextIndex }).description}
                fill
                className="object-cover"
                sizes="350px"
              />
          ...
          <div className="flex lg:hidden gap-2 overflow-x-auto snap-x snap-mandatory scrollbar-hide w-full">
            {images.map((image, idx) => (
              ...
              >
                <SeoImage
                  src={image}
                  alt={buildProjectImageSeo(currentLocale, { title, index: idx }).alt}
                  title={buildProjectImageSeo(currentLocale, { title, index: idx }).title}
                  description={buildProjectImageSeo(currentLocale, { title, index: idx }).description}
                  fill
