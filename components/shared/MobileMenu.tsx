...
export default function MobileMenu({ isOpen, onClose }: MobileMenuProps) {
  ...
  return (
    <>
      ...
      {/* Menu Panel */}
      <div
        className="fixed top-0 right-0 h-full w-full sm:w-[400px] bg-[#161616] z-50 transform transition-transform duration-300 ease-in-out translate-x-0"
        role="dialog"
        aria-modal="true"
        aria-label={tm('title')}
      >
        <div className="flex flex-col h-full px-[24px] py-[24px]">
          ...
          <div className="flex flex-col pt-[24px]">
            ...
            <div className="flex items-center justify-center opacity-100">
              <PaymentLogos variant="default" className="justify-center" />
            </div>
