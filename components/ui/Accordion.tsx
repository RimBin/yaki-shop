    ...
    <div className="flex flex-col w-full">
      {items.map((item, index) => (
        ...
        >
          ...
          <div className={`overflow-hidden transition-all duration-300 ${openIndex === index ? 'max-h-[1600px] pb-[16px]' : 'max-h-0'}`}>
            <div className="pr-[24px] font-['Outfit'] font-light text-[14px] leading-[1.5] tracking-[0.14px] text-[#535353]">
