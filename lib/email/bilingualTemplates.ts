...
export const BILINGUAL_EMAIL_TEMPLATES: EmailTemplateDefinition[] = [
  {
    ...
    html: {
      ...
      ${button('Peržiūrėti užsakymą', 'https://shop.yakiwood.co.uk/account/orders/{{orderNumber}}')}
    ...
    `
      ...
      ${button('View Order', 'https://shop.yakiwood.co.uk/account/orders/{{orderNumber}}')}
...

  {
    ...
    html: {
      ...
      ${button('Grįžti į krepšelį', 'https://shop.yakiwood.co.uk/cart')}
    `
      ),
      en: emailWrapper(
        'en',
      ...
      ${button('Return to Cart', 'https://shop.yakiwood.co.uk/cart')}
    `
      ),
    },
  },
...

  {
    ...
    html: {
      ...
      ${button('Apsilankyti svetainėje', 'https://shop.yakiwood.co.uk')}
    ...
    `
      ...
      ${button('Visit Website', 'https://shop.yakiwood.co.uk')}
...

  {
    ...
    html: {
      ...
      ${button('Pradėti apsipirkimą', 'https://shop.yakiwood.co.uk/produktai')}
    `
      ),
      en: emailWrapper(
        'en',
      ...
      ${button('Start Shopping', 'https://shop.yakiwood.co.uk/products')}
    `
      ),
    },
  },
...
export function getSampleData(templateId: string): Record<string, any> {
  const samples: Record<string, any> = {
    ...
    'back-in-stock': {
      ...
      price: '29.99',
      productUrl: 'https://shop.yakiwood.co.uk/produktai/shou-sugi-ban-premium',
    },
    newsletter: {
      ...
      featuredProducts: [
        { name: 'Premium Black', price: '29.99', url: 'https://shop.yakiwood.co.uk/produktai/premium-black' },
        { name: 'Natural Brown', price: '27.99', url: 'https://shop.yakiwood.co.uk/produktai/natural-brown' },
      ],
      unsubscribeUrl: 'https://shop.yakiwood.co.uk/newsletter/unsubscribe',
    },
    'password-reset': {
      resetUrl: 'https://shop.yakiwood.co.uk/auth/reset-password?token=abc123def456',
      expiryHours: '24',
    },
    'review-request': {
      productName: 'Shou Sugi Ban Premium Black',
      reviewUrl: 'https://shop.yakiwood.co.uk/produktai/shou-sugi-ban-premium/review',
    },
