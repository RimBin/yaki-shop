...
export const EMAIL_TEMPLATES: EmailTemplate[] = [
  // 1. ORDER CONFIRMATION
  {
    ...
    html: (vars) => emailWrapper(`
      ...
      ${button('View Order', `https://shop.yakiwood.co.uk/account/orders/${vars.orderNumber}`)}
...
export function getSampleData(templateId: string): Record<string, any> {
  const samples: Record<string, any> = {
    ...
    'back-in-stock': {
      ...
      price: '29.99',
      productUrl: 'https://shop.yakiwood.co.uk/products/shou-sugi-ban-premium',
      productImage: '',
    },
    'newsletter': {
      ...
      featuredProducts: [
        { name: 'Premium Black', price: '29.99', url: 'https://shop.yakiwood.co.uk/products/premium-black', image: '' },
        { name: 'Natural Brown', price: '27.99', url: 'https://shop.yakiwood.co.uk/products/natural-brown', image: '' },
      ],
    ...
    'review-request': {
      productName: 'Shou Sugi Ban Premium Black',
      reviewUrl: 'https://shop.yakiwood.co.uk/products/shou-sugi-ban-premium/review',
    },
