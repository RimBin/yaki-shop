...
import { absoluteUrl, getDeploymentSiteOrigin } from '@/lib/seo/site'
...
export function generateProductSchema(product: Product) {
  const offerUrl = product.url || absoluteUrl(product.sku ? `/products/${product.sku}` : '/products')
...
/**
 * Generate WebSite schema for homepage-level structured data
 */
...
/**
 * Generate ItemList schema for listing pages such as product archives
 */
