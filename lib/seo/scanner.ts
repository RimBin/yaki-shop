 ...
 * Provides heuristic SEO reporting for admin tools based on known route mappings.
 */
 ...
 * This reporting helper does not parse source files directly; it derives expected
 * metadata from maintained route-to-metadata mappings used by admin diagnostics.
 */
export async function extractMetadataFromPage(filePath: string, url: string): Promise<PageMetadata | null> {
  ...
  // Heuristic metadata based on file path
  const metadataMap: Record<string, PageMetadata> = {
    // Homepage - HAS full metadata
    'app/page.tsx': {
      url: `${baseUrl}/`,
      title: 'Yakiwood - Shou Sugi Ban Burnt Wood in the UK',
      description: 'Highest quality Shou Sugi Ban burnt wood products delivered across the UK. Facades, interior, terrace - ecological and durable solutions.',
      openGraph: {
        title: 'Yakiwood - Shou Sugi Ban burnt wood',
        description: 'Highest quality Shou Sugi Ban burnt wood products delivered across the UK. Facades, interior, terrace - ecological and durable solutions.',
        type: 'website',
        siteName: 'Yakiwood',
        images: [
    ...
    // Produktai - inherited from products layout
    'app/produktai/page.tsx': {
      url: `${baseUrl}/produktai`,
      title: 'Products - Shou Sugi Ban Burnt Wood',
      description: 'Discover our range of Shou Sugi Ban burnt wood products - planks, tiles, and facade cladding.',
    },

    // Sprendimai - HAS metadata
    'app/sprendimai/page.tsx': {
      url: `${baseUrl}/sprendimai`,
      title: 'Solutions - Shou Sugi Ban Applications',
      description: 'Explore various Shou Sugi Ban wood applications - from facades to interior design.',
    },

    // Projektai - inherited from projects layout
    'app/projektai/page.tsx': {
      url: `${baseUrl}/projektai`,
      title: 'Projects - Shou Sugi Ban Examples',
      description: 'Browse our portfolio of completed Shou Sugi Ban projects and get inspired for your project.',
    },
    ...
    // Account - metadata defined in layout
    ...
    // Login - metadata defined in layout
    'app/login/page.tsx': {
      url: `${baseUrl}/login`,
    ...
    // Register - metadata defined in layout
    'app/register/page.tsx': {
      url: `${baseUrl}/register`,
      title: 'Register - Yakiwood Account',
      description: 'Create your Yakiwood account to save projects, manage orders, and speed up checkout.',
      robots: {
        index: false,
        follow: false,
      },
    ...
    // Newsletter - HAS metadata
    'app/naujienos/page.tsx': {
      url: `${baseUrl}/naujienos`,
      title: 'News about Shou Sugi Ban',
      description: 'Read the latest news about Shou Sugi Ban, our projects, and wood processing updates.',
    },

    'app/checkout/page.tsx': {
      url: `${baseUrl}/checkout`,
      title: 'Checkout',
      description: 'Complete your Yakiwood order, review your cart, and enter shipping and payment details.',
      robots: {
        index: false,
        follow: false,
      },
    ...
    'app/order-confirmation/page.tsx': {
      ...
      description: 'Review your confirmed Yakiwood order details and the next delivery steps.',
      robots: {
        index: false,
        follow: false,
      },
    ...
    'app/forgot-password/page.tsx': {
      ...
      description: 'Recover your Yakiwood account password and request a secure reset link by email.',
      robots: {
        index: false,
        follow: false,
      },
    ...
    'app/reset-password/page.tsx': {
      ...
      description: 'Set a new password for your Yakiwood account and regain access to your orders and settings.',
      robots: {
        index: false,
        follow: false,
      },
    ...
    'app/eu-projects/page.tsx': {
      url: `${baseUrl}/eu-projects`,
      title: 'EU projects',
      description: 'Learn more about Yakiwood projects supported or funded by the European Union.',
    },

    'app/cookie-policy/page.tsx': {
      url: `${baseUrl}/cookie-policy`,
      title: 'Cookie policy',
      description: 'Learn how Yakiwood uses cookies, what data is collected, and how you can manage your preferences.',
    },

    'app/policies/page.tsx': {
      url: `${baseUrl}/policies`,
      title: 'Policies',
      description: 'Review Yakiwood policies for delivery, payment, refunds, and terms of use.',
    },

    'app/policies/shipping/page.tsx': {
      url: `${baseUrl}/policies/shipping`,
      title: 'Shipping policy',
      description: 'See Yakiwood delivery timelines, covered areas, kerbside freight conditions, and shipping details.',
    },

    'app/policies/refund/page.tsx': {
      url: `${baseUrl}/policies/refund`,
      title: 'Refund policy',
      description: 'Review Yakiwood return, cancellation, and defective goods terms under applicable consumer rules.',
    },

    'app/policies/terms/page.tsx': {
      url: `${baseUrl}/policies/terms`,
      title: 'Terms and conditions',
      description: 'Read Yakiwood terms and conditions covering orders, bespoke production, delivery, and liability.',
    },
  };
...
export async function scanAllPages(): Promise<PageSEOResult[]> {
  ...
  // Build a consistent report for all configured static pages.
  // This scanner is intentionally heuristic and should not be treated as the
  // source of truth for runtime metadata generation.
  const pages: PageSEOResult[] = STATIC_PAGES.map((page) => {
    const derivedMetadata: PageMetadata = {
      url: `${baseUrl}${page.path}`,
      title: getDerivedTitle(page.path),
      description: getDerivedDescription(page.path),
      openGraph: {
        title: getDerivedTitle(page.path),
        description: getDerivedDescription(page.path),
    ...
    const validation = validatePageMetadata(derivedMetadata);

    return {
      path: page.path,
      title: derivedMetadata.title,
      description: derivedMetadata.description,
      url: derivedMetadata.url,
      openGraph: derivedMetadata.openGraph,
      twitter: derivedMetadata.twitter,
...
function getDerivedTitle(path: string): string {
...
function getDerivedDescription(path: string): string {
