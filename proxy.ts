...
const ltToEn: PrefixMap = [
  { from: '/paskyra/duomenys', to: '/account/details' },
  { from: '/paskyra/uzsakymai', to: '/account/orders' },
  { from: '/paskyra/saskaitos', to: '/account/invoices' },
  { from: '/paskyra', to: '/account' },
  ...
  { from: '/administravimas/atsargos', to: '/admin/inventory' },
  ...
  { from: '/administravimas/backupai', to: '/admin/backups' },
